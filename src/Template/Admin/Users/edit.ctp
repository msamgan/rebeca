	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2><?= $user->name ?> Info<small>( Fields with * are mendetory to fill )</small></h2>
						<div class="clearfix"></div>
					</div>
					<div class="x_content">
						<br />
						<form id="user-edit" data-parsley-validate class="form-horizontal form-label-left" method="post">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="email" id="email" required="required" class="form-control col-md-7 col-xs-12" value="<?= $user->email ?>" name="email" >
								</div>
							</div>
